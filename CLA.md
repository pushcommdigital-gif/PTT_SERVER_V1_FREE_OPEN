# PushComm Contributor Licence Agreement

**Version 1.0**

Thank you for contributing to PushComm Community Edition.
...
If you are not comfortable with the second point, please do not sign — and
please still open the issue. A good bug report is a real contribution and needs
no agreement at all.
...
owned or managed by the Owner (the "Work").

**"Submitted"** means any form of electronic, verbal or written communication
sent to the Owner or its representatives, including but not limited to
communication on electronic mailing lists, source code control systems and
issue tracking systems that are managed by, or on behalf of, the Owner for the
...
**This includes the right to distribute Your Contribution under licences other
than the AGPL-3.0, including proprietary and commercial licences, and as part
...
stated in this section) patent licence to make, have made, use, offer to sell,
...
includes work you do on your own equipment or in your own time under many
employment contracts — you represent that you have received permission to make
the Contribution on behalf of that employer, that your employer has waived such
rights, or that your employer has executed a separate corporate CLA with the
Owner.
...
any third-party licence or other restriction (including related patents and
trademarks) of which you are personally aware and which are associated with any
part of Your Contributions.

**Do not paste in code you found elsewhere without saying so.** If part of your
contribution is not your own work, say exactly which part and under what
licence, so it can be reviewed.
...
### 8. Notify Us If Anything Changes
...
You do not need to sign anything by hand.

Open a pull request. The CLA Assistant bot will comment on it with a link, and
you accept by replying to the bot on your own pull request with:
...
future pull requests to this repository. You will not be asked again.

---

*Contact: pushcommdigital@gmail.com*
